<?php
    ...
    class ProductoTienda{
        ...
        function capturarImagenes($id_producto_tienda){
            $sql = "SELECT *
            FROM imagen
            WHERE imagen.id_producto=:id_producto
            AND imagen.estado = 'A'";
            $query = $this->acceso->prepare($sql);
            $query -> execute(array(':id_producto'=>$id_producto_tienda));
            $this->objetos =$query->fetchAll();
            return $this->objetos;
        }
        ...
        function capturar_caracteristicas($id_producto_tienda){
            $sql = "SELECT *
        ...
        function capturar_resenas($id_producto_tienda){
            ...
            calificacion , descripcion , fecha_creacion,
            u.usuario as user , u.avatar as avatar
            FROM resena r
